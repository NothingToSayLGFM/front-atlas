...
export const actions = {
  async getOrganisation ({ commit, getters, state }, [id, map]) {
    try {
      if (id) {
        ...
        // await this.$axios.post(`https://atlas-api.groupbwt.dev/v1/organisations/${id}`, {
        //   sections: [],
        //   filters: state.filter_options
        // })
        if (map) {
  ...
  async getCountry ({ commit, getters, state }, id) {
    try {
      if (id) {
        ...
        // await this.$axios.post(`https://atlas-api.groupbwt.dev/v1/countries/${id}`, {
        //   sections: [],
        //   filters: state.filter_options
        // })
        await commit('SET_SELECTED_ITEM_MAP', organisation.data.data)
  ...
  async getOrganisations ({ commit, getters, state }, id) {
    try {
      ...
      if (id) {
        ...
        // await this.$axios.post(`https://atlas-api.groupbwt.dev/v1/categories/${id}/organisations`, {
        //   sections: [],
        //   filters: state.filter_options
        // })
  ...
  async getFilters ({ commit, state }) {
    try {
      ...
      // await this.$axios.post('https://atlas-api.groupbwt.dev/v1/filters', {
      //   sections: [],
      //   filters: state.filter_options
      // })
  ...
  async getGraph ({ commit, state }) {
    try {
      ...
      // await this.$axios.post('https://atlas-api.groupbwt.dev/v1/graph', {
      //   sections: [],
      //   filters: state.filter_options
      // })
  ...
  async getMap ({ commit, state }) {
    try {
      ...
      // const map =  await this.$axios.post('https://atlas-api.groupbwt.dev/v1/map', {
      //   sections: [],
      //   filters: state.filter_options
      // })
